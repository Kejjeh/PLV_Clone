...
- **Add a 'Physical trend' row** to the head-to-head table so the comparison includes who is physically rising/falling, not just current level — a tiebreaker, never a re-rank.
