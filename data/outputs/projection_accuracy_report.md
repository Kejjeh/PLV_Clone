...
| 15 | 37 | 562.5 | 443.9 | MA_v1, backfill_2024_bayes_shrink, backfill_2025_bayes_shrink, baseline |
...
|---|---|---|---|---|---|---|---|
| `MA_v1` | 130 | 127.9 | 156.0 | +127.0 | 141.3 | 172.0 | +131.7 |
...
| `baseline` | 130 | 107.6 | 135.0 | +104.1 | 123.8 | 148.2 | +105.2 |
...
| 15 | `MA_v1` | 384.0 | 343.8 | +40.2 | 427.4 | 400.9 | +26.6 |
...
| 15 | `baseline` | 377.2 | 343.8 | +33.4 | 417.4 | 400.9 | +16.5 |
...
|---|---|---|---|---|---|
| 0.00-0.25 | 64 | 0.068 | 0.016 | 0.053 | OK |
...
| Bucket | n | mean predicted | actual win rate | abs gap | status |
|---|---|---|---|---|---|
| 0.00-0.25 | 65 | 0.086 | 0.015 | 0.070 | OK |
