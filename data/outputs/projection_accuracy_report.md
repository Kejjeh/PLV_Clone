...
| 14 | 9 | 563.1 | 429.5 | MA_v1, backfill_2024_bayes_shrink, backfill_2025_bayes_shrink, baseline |
...
|---|---|---|---|---|---|---|---|
| `MA_v1` | 101 | 121.8 | 152.4 | +120.6 | 133.8 | 166.4 | +121.5 |
...
| `baseline` | 101 | 100.0 | 130.2 | +95.5 | 117.7 | 143.3 | +93.9 |
...
| 14 | `MA_v1` | 350.5 | 46.1 | +304.4 | 378.7 | 50.9 | +327.8 |
...
| 14 | `baseline` | 317.5 | 46.1 | +271.4 | 335.1 | 50.9 | +284.2 |
...
|---|---|---|---|---|---|
| 0.00-0.25 | 38 | 0.085 | 0.000 | 0.085 | OK |
| 0.25-0.50 | 25 | 0.332 | 0.120 | 0.212 | OK |
...
| Bucket | n | mean predicted | actual win rate | abs gap | status |
|---|---|---|---|---|---|
| 0.00-0.25 | 38 | 0.097 | 0.000 | 0.097 | OK |
| 0.25-0.50 | 22 | 0.362 | 0.000 | 0.362 | OK |
