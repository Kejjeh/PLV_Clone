...
| 12 | 73 | 406.5 | 479.2 | MA_v1, backfill_2024_bayes_shrink, backfill_2025_bayes_shrink, baseline |
...
|---|---|---|---|---|---|---|---|
| `MA_v1` | 82 | 109.5 | 140.6 | +108.1 | 122.2 | 155.7 | +107.1 |
...
| `baseline` | 82 | 87.2 | 118.2 | +81.8 | 107.9 | 133.3 | +78.5 |
...
| 12 | `MA_v1` | 390.3 | 201.0 | +189.3 | 408.6 | 210.8 | +197.8 |
...
| 12 | `baseline` | 370.1 | 201.0 | +169.1 | 390.7 | 210.8 | +179.9 |
...
|---|---|---|---|---|---|
| 0.00-0.25 | 22 | 0.088 | 0.000 | 0.088 | OK |
| 0.25-0.50 | 23 | 0.338 | 0.130 | 0.208 | OK |
...
| Bucket | n | mean predicted | actual win rate | abs gap | status |
|---|---|---|---|---|---|
| 0.00-0.25 | 22 | 0.100 | 0.000 | 0.100 | OK |
