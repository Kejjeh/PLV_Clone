...
| 15 | 51 | 562.5 | 443.9 | MA_v1, backfill_2024_bayes_shrink, backfill_2025_bayes_shrink, baseline |
...
|---|---|---|---|---|---|---|---|
| `MA_v1` | 137 | 129.6 | 157.0 | +128.5 | 142.8 | 172.5 | +133.7 |
...
| `baseline` | 137 | 109.4 | 136.1 | +105.7 | 125.1 | 149.0 | +107.5 |
...
| 15 | `MA_v1` | 531.8 | 552.1 | -20.3 | 635.5 | 581.4 | +54.1 |
...
| 15 | `baseline` | 522.7 | 552.1 | -29.4 | 623.8 | 581.4 | +42.4 |
...
|---|---|---|---|---|---|
| 0.00-0.25 | 71 | 0.063 | 0.014 | 0.049 | OK |
...
| Bucket | n | mean predicted | actual win rate | abs gap | status |
|---|---|---|---|---|---|
| 0.00-0.25 | 72 | 0.079 | 0.014 | 0.065 | OK |
