...
| 13 | 29 | 603.7 | 512.6 | MA_v1, backfill_2024_bayes_shrink, backfill_2025_bayes_shrink, baseline |
...
|---|---|---|---|---|---|---|---|
| `MA_v1` | 97 | 121.3 | 151.8 | +120.2 | 133.5 | 166.0 | +120.7 |
...
| `baseline` | 97 | 99.2 | 129.4 | +94.6 | 117.7 | 142.9 | +92.8 |
...
| 13 | `MA_v1` | 345.3 | 202.2 | +143.1 | 390.8 | 239.3 | +151.5 |
...
| 13 | `baseline` | 334.5 | 202.2 | +132.3 | 374.0 | 239.3 | +134.7 |
...
|---|---|---|---|---|---|
| 0.00-0.25 | 35 | 0.078 | 0.000 | 0.078 | OK |
...
| Bucket | n | mean predicted | actual win rate | abs gap | status |
|---|---|---|---|---|---|
| 0.00-0.25 | 36 | 0.094 | 0.000 | 0.094 | OK |
