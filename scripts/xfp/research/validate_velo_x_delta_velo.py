"""validate_velo_x_delta_velo.py — interaction-term candidate for rp3.

Pre-registered: data/research/validation_runs/velo_x_delta_velo_2026-05-24.md
"""
...
def main():
    print('=== validate_velo_x_delta_velo: interaction = avg_velo_to * delta_velo ===')
    rolling = prep_rolling()
    print(f'  rolling rows: {len(rolling)}')

    col = 'velo_x_delta_velo'
    rolling[col] = rolling['avg_velo_to'] * rolling['delta_velo']
