"""validate_avg_pfxz_to.py — test season-to-date avg vertical pitch break as rp3 feature.

Pre-registered: data/research/validation_runs/avg_pfxz_to_2026-05-24.md
"""
...
def main():
    print('=== validate_avg_pfxz_to: candidate = season-to-date avg vertical pitch break ===')
