"""validate_avg_velo_last21.py — test raw L21 fastball velo level as rp3 feature.

Pre-registered: data/research/validation_runs/avg_velo_last21_2026-05-24.md
"""
...
def main():
    print('=== validate_avg_velo_last21: candidate = raw L21 average fastball velo ===')
    ...
    print(f'  filling NaN with population mean: {mu:.3f} mph')
