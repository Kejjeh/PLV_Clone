"""Validation: milb_aaa_kpct_prior as a rh3 v3 candidate feature.

Pre-reg: data/research/validation_runs/milb_aaa_kpct_prior_2026-05-24.md
"""
...
def main() -> None:
    print("=== /validate-feature: milb_aaa_kpct_prior (rh3 v3 candidate, MiLB data layer 2026-05-24) ===")
    print("Pre-reg: data/research/validation_runs/milb_aaa_kpct_prior_2026-05-24.md")
    print()
    result = run_milb_candidate_eval("milb_aaa_kpct_prior", expected_sign="-")
